...
class ExerciseRunner:
    ...
    def do_net_cli(self):
        ...
        # Run scripts on specific hosts
        """script_command_h1 = './scripts/mininet_script.py &'
        script_command_h2 = 'sleep 4h; nmap -T1 10.0.3.3 &'
        script_command_other_hosts = './D-ITG-2.8.1-r1023/bin/ITGRecv &'

        hosts_to_run_common_script = [self.net['h3'], self.net['h4'], self.net['h5'], self.net['h6']]
        for host in hosts_to_run_common_script:
            host.cmd(script_command_other_hosts)

        self.net['h1'].cmd(script_command_h1)
        self.net['h2'].cmd(script_command_h2)"""
